...
public:
    CalibrationDataReader(
        ...
        void (*preprecess)(cv::Mat &, int, int, float *),
...
private:
    ...
    void (*mPreprocess)(cv::Mat &, int, int, float *);
};
...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        auto calibrator = new CalibrationDataReader(calib_dir, calib_list_file, input_name, input_h, input_w, SMOKEPreprocess);
    ...
    // // 1. Create CUDA stream for profiling
